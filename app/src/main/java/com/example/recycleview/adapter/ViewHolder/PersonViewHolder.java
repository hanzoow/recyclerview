...
public class PersonViewHolder extends RecyclerView.ViewHolder {
    ...
    public PersonViewHolder(@NonNull View itemView, PersonAdapterClickListener listener) {
        super(itemView);
...
//        itemView.setTag(person);
        ...
        if (person.getPreperence().equals("bus")) {
            ivPref.setImageResource(R.drawable.ic_directions_bus_black_24dp);
        } else {
            ivPref.setImageResource(R.drawable.ic_flight_black_24dp);
        }
